-- Migration: 20260524000006_fix_sync_trigger_role_name.sql
-- Patch: the sync_auth_user_metadata() function incorrectly referenced
-- ur.role — the actual column on public.user_roles is role_name.
-- Also carries the dept_id fix from 00005 so the full function is canonical.
...
BEGIN
  ...
  -- Aggregate roles (role_name is the correct column name on user_roles)
