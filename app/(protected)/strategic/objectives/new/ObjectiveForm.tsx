...
// Create-objective form following RegisterForm.tsx pattern exactly.
// react-hook-form + Zod resolver, calls createObjective Server Action on submit.
...
import type { Nds2Pillar, ObjectiveStatus } from '@/types/strategic'
import {
  Form,
  FormField,
  FormItem,
...
export function ObjectiveForm({ owners }: ObjectiveFormProps) {
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input
                    type="text"
                    placeholder="e.g. Increase domestic revenue mobilisation by 25%"
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem className="mt-4">
                ...
                <FormControl>
                  <Textarea
                    placeholder="Provide additional context or background..."
