...
This roadmap follows a dependency-driven build order: Foundation (auth + RLS + audit) â†’ Strategic Planning â†’ Risk Management â†’ Compliance â†’ Board Governance â†’ Internal Audit â†’ Incident Management â†’ Executive Reporting. Each phase delivers a complete, verifiable capability with observable success criteria.

---

## Phases

### Phase 1: Foundation â€” Authentication, RLS, and Audit Trail
...
### Phase 2: Strategic Planning â€” Objectives and KPIs
...
### Phase 3: Enterprise Risk Management â€” Risk Register and Heatmap
**Goal:** Risk officers can create and score risks linked to strategic objectives, record mitigations, and see a live 5Ã-5 risk heatmap.
...
2. User can score a risk on a 5Ã-5 likelihood-impact matrix (1â€“5 scale each dimension) for inherent risk
3. User can record residual risk score after applying mitigating controls and see the change reflected immediately
4. System calculates risk score (likelihood Ã- impact) and applies severity labels (Low 1â€“4, Medium 5â€“9, High 10â€“15, Critical 16â€“25)
...
7. Dashboard displays a live 5Ã-5 risk heatmap showing all institutional risks positioned by inherent score with color-coded severity zones
**UI hint**: yes

---

### Phase 4: Compliance Management — Obligations and Evidence ✅ COMPLETE
...
Plans:
- [x] 04-01-PLAN.md — Database migrations (schema + RLS + triggers) + types + Zod schemas + utility functions + supabase db push
- [x] 04-02-PLAN.md — Server Actions (createObligation, attestObligation, uploadEvidence) + query helpers + escalation service + escalate API route
- [x] 04-03-PLAN.md — Evidence download Route Handler with SHA-256 integrity verification + next.config.mjs bodySizeLimit
- [x] 04-04-PLAN.md — Compliance posture dashboard + obligations list + TanStack Table + create obligation form
- [x] 04-05-PLAN.md — Obligation detail page + evidence upload form (browser SHA-256) + attestation form + EvidenceFileRow + AttestationRow
- [x] 04-06-PLAN.md — Compliance nav item in sidebar + human verification of all Phase 4 workflows

---

### Phase 5: Board Management â€” Meetings and Resolutions
...
**Success Criteria:**
1. Admin can create a board meeting with date, agenda items list, and attendee roster; meeting state transitions from Scheduled â†’ In Progress â†’ Closed
...
Plans:
- [ ] 06-01-PLAN.md - Audit schema/RLS/trigger migrations + audit types + validation schemas + utility contracts
- [ ] 06-02-PLAN.md - Server Actions + query helpers + escalation service + protected /api/audit/escalate route
- [ ] 06-03-PLAN.md - Audit dashboard + findings list table + new finding form workflow
- [ ] 06-04-PLAN.md - Finding detail + status update flow + remediation evidence upload UX
- [ ] 06-05-PLAN.md - Audit nav integration + end-to-end human verification checkpoint
...
### Phase 7: Incident and Whistleblower Management â€” Reporting and Triage
...
4. Investigators can triage new cases (status: New â†’ Assigned â†’ In Investigation â†’ Escalated â†’ Closed) and reassign cases to other investigators without losing history
...
### Phase 8: Executive Dashboard and Reporting â€” Unified Governance View
...
**Success Criteria:**
1. Executive dashboard displays a unified consolidated view with KPI summary grid, 5Ã-5 risk heatmap, compliance posture card (% met, overdue count, expiring 30-days), and top 10 overdue governance actions
...
|-------|------|--------------|--------|-----------|
| 1 | Foundation | 12 | Not Started | â€” |
| 2 | Strategic Planning | 6 | Not Started | â€” |
| 3 | Enterprise Risk Management | 8 | Not Started | â€” |
| 4 | Compliance Management | 6 | Not Started | â€” |
| 5 | Board Management | 6 | Not Started | â€” |
| 6 | Internal Audit | 5 | Not Started | â€” |
| 7 | Incident & Whistleblower | 5 | Not Started | â€” |
| 8 | Executive Dashboard & Reporting | 4 | Not Started | â€” |
